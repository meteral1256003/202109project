...
<div class="main-wrapper ">
    ...
    <form action="/one_board/one_modify?page=${page}" name="modify" method="post" enctype="multipart/form-data">
      <table>
      ...
      <input type="hidden" name="old_bupload" value="${one_boardVo.bupload}">
        ...
        <tr>
          <th>작성자</th>
          <td>
            <input type="text" name="bname" value="${one_boardVo.bname}">
          </td>
        </tr>
        <tr>
          <th>제목</th>
          <td>
            <input type="text" name="btitle" value="${one_boardVo.btitle}">
          </td>
        </tr>
        <tr>
          <th>내용</th>
          <td>
            <textarea name="bcontent" cols="50" rows="10">${one_boardVo.bcontent}</textarea>
          </td>
        </tr>
        <tr>
      ...
      <div class="button-wrapper">
        ...
        <button type="button" class="cancel" onclick="javascript:location.href='one_list?page=${page}'">취소</button>
      </div>
    </form>
