...
<script type="text/javascript">
	function boardDelete() {
		if (confirm("삭제하시겠습니까?") == true) {
			location.href = "event_delete?id=" + ${notice_boardVo.id}	+"&page=" + ${page};
		}
	}
</script>
</head>
...
<body>
	...
	<div class="main-wrapper ">
		...
		<section>
			...
			<a href="/event_board/event_list?page=${page}"><div class="list">목록</div></a>
			...
			<a href="event_modify?id=${notice_boardVo.id}&page=${page}"><div class="list">수정</div></a> 
			</c:if>
