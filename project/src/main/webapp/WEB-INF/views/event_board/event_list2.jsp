				...
				<div id="contents">
					<div id="mypage">
						...
						<div class="eventList">
							<ul>
								<!-- 반복 -->
								<li>
									<c:forEach items="${map.list2}" var="notice_boardVo">
									<div class="img">
					...
					<div class="text-center">
							...
							<div class="nav-links">
								...
								<c:if test="${map.page > 1 }">
									<a class="prev page-numbers"
										href="event_list2?page=${map.page-1}&category=${map.category}&searchWord=${map.searchWord}">Prev</a>
								</c:if>
								...
								<c:forEach var="nowpage" begin="${map.startpage}"
									...
									<c:if test="${map.page != nowpage }">
										<a href="event_list2?page=${nowpage }&category=${map.category}&searchWord=${map.searchWord}">
						...
						<div class="searchWrap">
							<div class="search">
								<ul>
								<form action="/event_board/event_list2" id="search" name="search"
						method="post">
