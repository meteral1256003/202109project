...
<div class="main-wrapper ">
	      ...
	      <div class="col-md-12">
	        <div class="block text-center">
	          ...
	          <ul class="list-inline">
	            ...
	            <li class="list-inline-item"><a href="event_list" class="text-white-50">Board</a></li>
	          </ul>
	        </div>
	      </div>
	    </div>
    ...
    <form action="/event_board/event_modify?page=${page}" name="modify" method="post"  enctype="multipart/form-data">
      ...
      <table>
        ...
        <tr>
          <th>시작일</th>
          <td>
            <input type="text" name="sdate" id="sdate" onblur="sdateCheck()" value="${notice_boardVo.sdate}" placeholder="ex) 2021-09-20">
          </td>
        </tr>
        <tr>
          <th>종료일</th>
          <td>
            <input type="text" name="edate" id="edate" onblur="edateCheck()" value="${notice_boardVo.edate}" placeholder="ex) 2021-09-20">
          </td>
        </tr>
        <tr>
          <th>내용</th>
      ...
      <div class="button-wrapper">
        ...
        <button type="button" class="cancel" onclick="javascript:location.href='event_list?page=${page}'">취소</button>
      </div>
    </form>
