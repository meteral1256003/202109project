...
<div class="main-wrapper ">
	    ...
	    <div class="row">
	      <div class="col-md-12">
	        <div class="block text-center">
	          ...
	          <h1 class="text-capitalize mb-4 text-lg">공지사항 글쓰기</h1>
    ...
    <form action="/notice_board/notice_write" name="boardWrite" method="post" enctype="multipart/form-data">
      <table>
        <colgroup>
          <col width="15%">
          <col width="85%">
      ...
      <div class="/button-wrapper">
        ...
        <button type="button" class="cancel" onclick="javascript:location.href='notice_list?page=${param.page}'">취소</button>
      </div>
    </form>
